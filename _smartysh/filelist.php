...
echo '<tr><td colspan="2"><a href="' . (!$config["template_edit_links_downloadable"]?$config["basepath_local"]:"") . "/" . $site_dir . $config["path_templates_pages"] . "/" . $page_template . '">edit this page</a> or layout</td></tr>';
...
function tpl_to_link($tpl_name, $site_dir, $style=false) {
    ...
    return '<tr><td><a style="' . $style . '" href="/' . $site_dir . "/" . $html_name . '">' . $html_name . '</a></td><td><a style="' . $style . '" href="' . (!$config["template_edit_links_downloadable"]?$config["basepath_local"]:"") . "/" . $site_dir . $config["path_templates_pages"] . "/" . $tpl_name . '">(edit)</a></td></tr>';
}

...
<div id="sidecontent">
  <h2>Contact</h2>
  Nordic Wood Energy OÜ<br />
  Reg nr. 12345<br />
  Swedbank A/A 123467890<br />
  Tänav 1, Pärnu maakond, Audru vald<br /><br />

  Tel. +372 555 666 77<br />
  Tel. +372 342 666 78<br />
  <a href="">info@nwe.ee</a>
</div>

<div id="maincontent" class="def">
  <h1>Welcome!</h1>
  ...
  <img src="images/data/sample_image.jpg" alt="" style="float: right" />
  ...
  <img src="images/data/sample_image.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto;" />
  ...
  <img src="images/data/sample_image.jpg" alt="" style="float: left" />
